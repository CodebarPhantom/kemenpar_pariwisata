...
@endphp
<div class="row">
    <form role="form" id="form_1" action="{{ route('dashboard.user') }}" method="GET" class="col-md-12" enctype="multipart/form-data">
        @csrf
        <div class="">
        ...
        data: {
            labels  : [  
                ...
                for ($day = 1; $day <= $dayInMonth; $day++) {
                    echo "'".Carbon::createFromFormat("d-m", $day.'-'.$monthReport)->format('d M')."',";
                }
                @endphp
            ],
