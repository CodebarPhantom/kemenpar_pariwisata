...
class LoginController extends Controller
{
    ...
    public function show()
    {
        ...
        // return TourismInfo::select('tourism_infos.*')
        ...
        // return TourismInfoCategories::select('tourism_info_categories.*')
        ...
        // return TicketItems::select('ticket_items.*')
        ...
        // return TicketPromotion::select('ticket_promotions.*')
